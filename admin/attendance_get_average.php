<?php
$sqlapavg = "SELECT * FROM attendance_data WHERE student_uname = '$matric_id' AND (attendance_status = 1 OR attendance_status = 2)";
...
$sqlavavg = "SELECT * FROM attendance_data WHERE student_uname = '$matric_id'";
