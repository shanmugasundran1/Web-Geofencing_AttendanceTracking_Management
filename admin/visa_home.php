  ...
  <div class="content-wrapper">
    <section class="content-header card bg-dark rounded-0">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family:Franklin Gothic Medium; font-weight:bold;">APPLICATION VIEW</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="student_browse.php">Visa</a></li>
              <li class="breadcrumb-item">Applications View</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-3">
            <div class="card card-primary border border-dark">
              ...
              <div class="card-body box-profile">
                <div class="text-center"><img class="img-thumbnail" src="../student/student_profile/<?php echo $profile_pic; ?>" alt="User profile picture" /></div>
                <br>
                <h3 class="profile-username text-center"><?php echo $acc_fullname; ?></h3>
                <p class="text-center"><?php echo strtoupper($matric_id); ?></p>
              </div>
            </div>
            <div class="card card-primary border border-dark">
            ...
            <div class="card card-success border border-dark">
              ...
              <div class="card-body">
                ...
                <?php
                $sqlcourse = "SELECT * FROM student_course where acc_uname ='$matric_id' ORDER BY CourseCode ASC";
              ...
              <div class="card-header p-2" style="background: black; color:white;">
                <ul class="nav nav-pills">
                  ...
                  if (is_null($matric_id)) {
                    ...
                    echo '<li class="nav-item"><a class="nav-link" href="#details" data-toggle="tab" style="color:white">Application Details</a></li>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" action="visa_setInfo.php" method="post">
                      ...
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputmobile" name="inputpost_name" placeholder="Without any symbols">
                          </div>
                          <label for="inputpriv_email" class="col-sm-5 col-form-label">Given Name</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputpriv_email" name="inputgiven_name" placeholder="Without any symbols">
                          </div>
                          <label for="inputaddress" class="col-sm-2 col-form-label">Surname</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputmobile" name="inputsur_name" placeholder="Without any symbols">
                          </div>
                          <label for="inputcity" class="col-sm-2 col-form-label">Birthdate</label>
                          <div class="col-sm-10">
                            <input type="date" class="form-control" id="inputcity" name="inputbirth_date" placeholder="City">
                          </div>
                          <label for="inputstate" class="col-sm-5 col-form-label">Passport Number</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputstate" name="inputpass_number" placeholder="State">
                          </div>
                          ...
                          <div class="col-sm-10">
                            <input type="date" class="form-control" id="inputstate" name="inputissue_date" placeholder="State">
                          </div>
                          <label for="inputstate" class="col-sm-5 col-form-label">Expiration Date</label>
                          <div class="col-sm-10">
                            <input type="date" class="form-control" id="inputstate" name="inputexpiry_date" placeholder="State">
                          </div>
                          <label for="inputstate" class="col-sm-5 col-form-label">Visa Renewal Period</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputstate" name="inputrenewal_period" placeholder="State">
                          </div>
                        </div>
                      </div>
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          ...
                          <div class="input-group mt-1">
                            <div class="custom-file">
                              <input type="file" name="transcript" class="custom-file-input" id="customFile">
                              <label class="custom-file-label" for="inputGroupFile01">Choose File</label>
                            </div>
                          </div>
                        </div>
