...
$sqlap = "SELECT * FROM attendance_data WHERE course_id = '$course_id' AND student_uname = '$matric_id' AND (attendance_status = 1 OR attendance_status = 2)";
...
$sqlav = "SELECT * FROM attendance_data WHERE course_id = '$course_id' AND student_uname = '$matric_id'";
