    ...
    <div class="content-wrapper">
      <section class="content-header card bg-dark rounded-0">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 style="font-family:Helvetica; font-weight:bold;">Insert Geolocation Data</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active" style="color:white">Insert Geolocation Data</li>
              </ol>
            </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  <?php
                    if(isset($_POST['submit'])){
                      ...
                      $result = mysqli_query($mysqli, "INSERT INTO geolocation (location_ID,location_name,location_lat,location_long) VALUES ('$locationid','$locationname','$locationlat','$locationlong')");
                    }
                  ?>
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <input type="number" name="locationlat" step="any" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <input type="number" name="locationlong" step="any" class="form-control">                          
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
