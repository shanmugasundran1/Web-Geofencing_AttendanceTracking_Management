    ...
    <div class="content-wrapper">
      <section class="content-header card bg-dark rounded-0">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 style="font-family:Franklin Gothic Medium; font-weight:bold;">Key In Geolocation</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="attendance_select_course.php">Attendance</a></li>
                <li class="breadcrumb-item">Key In Geolocation</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-2">
                    <button onclick="location.href='insertgeo.php'" type="submit" name="submit"class="btn btn-primary">Insert New Geo Data</button>
                  </div>
                  <form action="importgeo.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-7">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-striped" style="background: white; color:black;">
                    ...
                    <tbody>
                      <?php
                        // Get member rows
                        $query = "SELECT * FROM geolocation ORDER BY location_ID ASC";
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['location_long']; ?></td>
                        <td>
                          <a href="editgeo.php?id=<?php echo $row['location_ID']; ?>" class="badge badge-success">Edit</a>
                          <a onClick="javascript: return confirm('Are you sure want to delete this location?');" href="deletegeo.php?id=<?php echo $row['location_ID']; ?>" class="badge badge-danger">Delete</a>
                        </td>
                      </tr>
                      <?php
                        }
