                ...
                <div class="card-body">
                  <?php
                    if(isset($_POST['submit'])){
                      ...
                      $result = mysqli_query($mysqli, "INSERT INTO course (courseid,CourseType,CourseCode,CourseName,ClassDetail,ClassDay,ClassDate,StartTime,EndTime,location_ID) VALUES ('$courseid','$coursetype','$coursecode','$coursename','$classdetail','$classday','$classdate','$starttime','$endtime','$locationid')");
                    }
                  ?>
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <input type="text" name="classdate" class="form-control" required> 
                        </div>
                      </div> 
                    </div>
                    <div class="form-group">
