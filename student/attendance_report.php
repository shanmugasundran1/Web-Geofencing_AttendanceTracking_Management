...
include 'attendance_get_reportInfo.php';
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="attendance.php">Attendance Report</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
              ...
              <td colspan="2">
                <table>
                  <tr>
                    <td class="title">
                  <tr>
                    <h1 style="display:block; text-align:center;"></span>ATTENDANCE REPORT</h1>
                  </tr>
              </td>
            </tr>
          </table>
        ...
        <div style="text-align:right;">
          <span>
            <img src="../sources/logo_letter.jpg" style="height:100px; float:left;"> <a href="attendance_view.php?course_id=<?php echo $course_id; ?>" class="btn btn-primary">
