...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="profile.php" class="brand-link">
      <img src="../sources/um_logo_only.png" alt="UM~ Logo" class="brand-image " style="opacity: 8"><span class="brand-text font-weight-light">E-Attendance@UM</span>
    </a>
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image"> <img src="student_profile/<?php echo $profile_pic; ?>" class="img-circle elevation-2" onerror="this.src='student_profile/default.png'"> </div>
        <div class="info"> <a href="#" class="d-block"><?php echo $loggedin_session; ?> &nbsp; | &nbsp;STUDENT</a> </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="student_schedule.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="attendanceinterface.php" class="nav-link">
              <i class="nav-icon fa fa-map-marker-alt"></i>
              <p>Mark Attendance</p>
            </a>
          </li>
          <?php if ($nationality == 'Non-Citizen') { ?>
            <li class="nav-item"> <a href="visa_home.php" class="nav-link"> <i class="nav-icon fa fa-plane"></i>
