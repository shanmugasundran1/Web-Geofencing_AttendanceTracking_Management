    ...
    <section class="content">
      <div class="container-fluid">
        <div class="invoice-box" style="background-color:white;">
          ...
          <tr class="details">
            <td>
			<a href="absence_download.php?filename=<?php echo $absence_doc; ?>" title="click to download" class="btn btn-secondary">Download</a> <a href="../lecturer/absence-files/<?php echo $absence_doc; ?>" target="_blank" title="click to download" class="btn btn-primary">View</a>
			</td>
            <td>
              <img src="../lecturer/absence-files/<?php echo $absence_doc; ?>" alt="<?php echo $absence_doc; ?>" onerror="this.src='../lecturer/absence-files/no-preview.jpeg'" style="width:400px;height:400px;">
            </td>
          </tr>
