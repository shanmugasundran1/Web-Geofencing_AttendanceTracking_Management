          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <a onClick="javascript: return confirm('Are you sure want to delete this feedback?');" href="feedback_delete.php?feedback_id=<?php echo $feedback_id; ?>" class="btn btn-danger">Delete</a>
              </div>
              <div class="card-body">
