...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col">
          <div class="card bg-primary" style="height : 220px;">
        ...
        <div class="col">
          <div class="card bg-warning" style="height : 220px;">
            <div class="card-header" style="background-color:black; color:white;">
        ...
        <div class="col">
          <div class="card bg-info">
            ...
            <div class="card-body box-profile" style="padding-top : 6px;">
              <div class="text-center"> <img class="img" src="../lecturer/lecturer_profile/<?php echo $lecturer_picture; ?>" onerror="this.src='student_profile/default.png'" style="height:80px;" />
                <h6 class="text-center"><b><?php echo $lecturer_name; ?></b></h6>
                <a href="lecturer_view.php?acc_uname=<?php echo $lecturer_id; ?>" class="btn btn-danger" title="Click to View More">View Profile</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <table id="example1" class="table table-striped" cellspacing="0" cellpadding="0">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th style="width: 20%" class="text-center">Absence Reason</th>
                      <th style="width: 20%">Absence Approval</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
						  ...
						  <?php
							  ...
							  {
                              ?>
							  <a class="btn btn-primary" href="absence_add.php?attendance_id=<?php echo $attendance_id ; ?>" ><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="white" class="bi bi-file-earmark-arrow-up-fill" viewBox="0 0 16 16"><path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zM6.354 9.854a.5.5 0 0 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 8.707V12.5a.5.5 0 0 1-1 0V8.707L6.354 9.854z" /></svg>Submit
							  <?php 
							  }
							  ?>
						   </td>
