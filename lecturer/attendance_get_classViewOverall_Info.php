...
$sqldate = "SELECT * FROM attendance_data WHERE course_id = '$course_id' ";
...
$sqlap = "SELECT * FROM attendance_data WHERE course_id = '$course_id' AND (attendance_status = 1 OR attendance_status = 2)";
...
$sqlcs = "SELECT DISTINCT student_uname FROM attendance_data WHERE course_id = '$course_id'";
