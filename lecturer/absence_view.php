...
include 'absence_get_viewInfo.php';
?>
  ...
  <div class="content-wrapper">
    <section class="content-header card bg-dark rounded-0">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-family:Franklin Gothic Medium; font-weight:bold;">ABSENCE LETTER</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="absence_select_course.php">Absence</a></li>
              <li class="breadcrumb-item">Absence Letter</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="invoice-box" style="background-color:white;">
          ...
          <tr class="details">
            <td>
				<a href="absence_download.php?filename=<?php echo $absence_doc; ?>" title="click to download" class="btn btn-secondary" onerror="this.src='404.php'">Download</a>
				<a href="../lecturer/absence-files/<?php echo $absence_doc; ?>" target="_blank" title="click to download" class="btn btn-primary">View</a>
			</td>
            <td>
              <img src="../lecturer/absence-files/<?php echo $absence_doc; ?>" onerror="this.src='absence-files/no-preview.jpeg'" style="width:400px;height:400px;">
            </td>
          </tr>
          <div style="text-align:right;">
            <span>
              <img src="../sources/logo_letter.jpg" style="height:100px; float:left;"> <a href="absence.php?course_id=<?php echo $course_id; ?>" class="btn btn-primary">
