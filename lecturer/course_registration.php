...
if(isset($_POST['submit']))
{
    ...
    $lecturer_id = $loggedin_id;
    $lecturer_uname = $loggedin_session;
    $coursecode = $row[2];
    $coursename = $row[3];
    $classdetail = $row[4];
    $classday = $row[5];
    ...
    $locationid = $row[9];
    $repeat = 1;
    mysqli_query($mysqli, "INSERT INTO lecturer_course(subject_id,lecturer_id,acc_uname,CourseCode,CourseName,ClassDetail,ClassDay,ClassDate,StartTime,EndTime,location_ID,is_repeating) 
    values('$courseid','$lecturer_id','$lecturer_uname','$coursecode','$coursename','$classdetail','$classday','$classdate','$starttime','$endtime','$locationid','$repeat')");
}
if(isset($_GET['del']))
    {
        $courseid = $_GET['id'];
        mysqli_query($mysqli, "DELETE from lecturer_course where subject_id = $courseid");
...
<html lang="en">
    <head>
        ...
        <title>Course Registration | E-Attendance@UM</title>
                            ...
                            <div class="card border border-dark" style="border-radius: 10px;">
                                <div class="card-body">
                                    <table id="example1" class="table table-striped" style="background: white; color:black;">
                                        ...
                                        <tbody>
                                            <?php
                                                $queryt = "SELECT * FROM lecturer_course WHERE lecturer_id=$loggedin_id";
