...
<head>
  ...
  <title>Attendance Analysis | E-Attendance@UM</title>
            ...
            <tbody>
              ...
              ?>
                  ...
                  <tr>
					...
					<td class="project-actions text-center"><a class="btn btn-primary btn-sm" href="analysis_view.php?course_id=<?php echo $course_id; ?>"> <i class="fas fa-folder"> </i> View </a>
					</td>
				  </tr>
				<?php
				}
