              ...
              <div class="card-body">
                <table id="example1" class="table table-striped table-sm" style="background: white; color:black;">
                  ...
                  <tbody>
                    ...
                    ?>
                        <?php
                        $resultchart = mysqli_query($mysqli, "SELECT course_name,AVG(rating), COUNT(*) AS frequencies FROM feedback WHERE lecturer_name = '$loggedin_name' and course_code='$course_code' and course_occurence='$course_occurence'");
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-warning btn-sm">
                              <h6>Messages&nbsp;<span class="badge badge-success"><?php echo $frequencies ?></span></h6>
                            </button><br><br>
                          </td>
                          <td><?php
                              for ($count = 0; $count < floor($checking); $count++) {
                                echo "<i class=\"fas fa-star text-warning\"></i>";
                              }
                              ?></td>
                          <td><a class="btn btn-primary" href="feedback.php?course_code=<?php echo $course_code; ?>&course_occurence=<?php echo $course_occurence; ?>" class="btn btn-secondary" title="Click to View More">View List</a></td>
                        </tr>
                    <?php
                      }
                    } else {
