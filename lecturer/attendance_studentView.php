        ...
        <div class="col">
          <div class="card border border-dark bg-info">
            ...
            <div class="card-body box-profile" style="padding-top : 6px;">
              <div class="text-center"> <img class="img-thumbnail" src="../student/student_profile/<?php echo $student_picturecheck; ?>" onerror="this.src='lecturer_profile/default.png'" style="height:80px;" />
                <h6 class="text-center"><b><?php echo $student_namecheck; ?></b></h6>
                <a href="student_view.php?acc_uname=<?php echo $student_check; ?>" class="btn btn-primary" title="Click to View More">View Profile</a>
              </div>
            </div>
          </div>
        </div>
